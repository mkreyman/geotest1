  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved dataset as @dataset" do
        ...
        post :create, {:dataset => { "name" => "invalid value" }}, valid_session
        assigns(:dataset).should be_a_new(Dataset)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested dataset" do
        ...
        Dataset.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => dataset.to_param, :dataset => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the dataset as @dataset" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Dataset.any_instance.stub(:save).and_return(false)
        put :update, {:id => dataset.to_param, :dataset => { "name" => "invalid value" }}, valid_session
        assigns(:dataset).should eq(dataset)
      end
